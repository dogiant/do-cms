                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        <header>
                                            ...
                                            <div class="toolbar">
                                                <ul class="nav">
                                                    <li><a href="concerned_reply_list.do">当前关注回复</a></li>
                                                    <li class="dropdown">
            ...
            $(function() {
            	...
            	$('#textDataTable').dataTable({
                    ...
                    "columnDefs": [  
                        ...
                        { "targets": [5],
                        "data": "id" ,
                        "render": function(data, type, full) { return "<button class='btn set'  dataid='"+data+"'><i class='icon-check' title='设定为关注回复'></i></button>"; } 
                        } 
                    ],
                ...
                $('#textDataTable tbody').on( 'click', 'button.set', function () {
                    var idsvalue = $(this).attr("dataid");
        			bootbox.confirm("您确定要设定此条消息为关注回复吗?", function(result) {
            			if(result){
                        	$.ajax({
                        		type:'post',
                        		url:'api/concerned_reply_set.do',
