                                    ...
                                    <div class="box dark">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	...
                                        	<div class="form-horizontal">
                                               	<s:form id="systemModelForm" namespace="/api" action="systemModel_add" method="post" > 
                                               	<div class="control-group">
                                                    <label for="text1" class="control-label">模块标识</label>
                                                    <div class="controls with-tooltip">
                                                        <s:textfield id="model" name="systemModel.model" class="span6 input-tooltip"
                                                               data-original-title="请输入模块标识" data-placement="bottom" ></s:textfield>
                                                    </div>
                                               	</div>
                                               	<div class="control-group">
                                                    <label for="text1" class="control-label">模块名称</label>
                                                    <div class="controls with-tooltip">
                                                        <s:textfield id="name" name="systemModel.name" class="span6 input-tooltip"
