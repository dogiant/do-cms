    ...
    <body>
	            ...
	            success: function(data) {
	                if(data.success){
	                	...
	                	$.each(data.pagedResult.rs, function(i, obj){      
	                	      var trHtml = "<tr dataid=\""+obj.roleId+"\">";
	                	      trHtml+="<td>"+obj.roleName+"</td>";
	                	      trHtml+="<td>";
	                	      trHtml+="<a href=\"role_modify.do?roleId="+obj.roleId+"\" dataid=\""+obj.roleId+"\" class=\"btn edit\">编辑</a>";
	                	      trHtml+="<a href=\"javascript:void(0)\" dataid=\""+obj.roleId+"\" class=\"btn btn-danger remove\">删除</a>";
	                	      trHtml+="</td>";
	                	      trHtml+="</tr>";
        ...
        $(function() {
        	...
        	$(document).on("click",".remove",function(){
        		...
        		var obj = $(this);
    			bootbox.confirm("您确定要将此角色删除吗?", function(result) {
        			if(result){
                    	$.ajax({
                    		type:'post',
                    		url:'api/role_delete.do',
                    		data:{"roleIds":idsvalue},
                    		dataType:'json',
                    		beforeSend: function(){
                    		},
                    		success:function(data){
