                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        ...
                                        <div  id="div-1"  class="accordion-body collapse in body">
                                            <table id="systemModelDataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                <thead>
                                                    <tr>
                                                    	<th>标识码</th>
														<th>名称</th>
	            ...
	            success: function(data) {
	                if(data.success){
	                	...
	                	$.each(data.pagedResult.rs, function(i, obj){      
	                	      ...
	                	      trHtml+="<td>"+obj.model+"</td>";
	                	      trHtml+="<td>"+obj.name+"</td>";
	                	      trHtml+="<td>";
	                	      trHtml+="<a href=\"systemModel_modify.do?model="+obj.model+"\" dataid=\""+obj.model+"\" class=\"btn edit\">编辑</a>";
	                	      trHtml+="<a href=\"javascript:void(0)\" dataid=\""+obj.model+"\" class=\"btn btn-danger remove\">删除</a>";
	                	      trHtml+="</td>";
	                	      trHtml+="</tr>";
	                	      htmlArray.push(trHtml);
	                	});
	                	$("#systemModelDataTable tbody").html(htmlArray.join(""));
