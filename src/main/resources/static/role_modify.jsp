                                    ...
                                    <div class="box dark">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	...
                                        	<div class="form-horizontal">
                                               	<s:form id="roleForm" namespace="/api" action="role_update" method="post" > 
                                               	<div class="control-group">
                                                	<s:hidden id="roleId" name="role.roleId" value="%{resultMap.role.roleId}"></s:hidden>
                                                    <label for="text1" class="control-label">角色名</label>
                                                    <div class="controls with-tooltip">
                                                        <s:textfield id="roleName" name="role.roleName" value="%{resultMap.role.roleName}" class="span6 input-tooltip"
													...
													<ul>
														...
														<s:iterator value="#systemModel.privileges" id="privilege" status="st2">
															<span><input type="checkbox" name="privilegePKStrs" value="<s:property value="#privilege.id.model"/>,<s:property value="#privilege.id.privilegeValue"/>"
																<s:if test="%{resultMap.role.hasPrivilege(#privilege.id.model,#privilege.id.privilegeValue)}">checked="checked"</s:if> />
