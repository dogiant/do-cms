                                    ...
                                    <div class="box dark">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	...
                                        	<div class="form-horizontal">
                                                <s:form id="templateForm" namespace="/api" action="template_update" method="post" > 
                                                <s:hidden  id="templateId" name="template.templateId" value="%{resultMap.template.templateId}"></s:hidden>
                                                <div class="control-group">
                                                    <label for="name" class="control-label">模板名称</label>
                                                    <div class="controls">
                                                    	<s:textfield id="templateName" name="template.templateName" value="%{resultMap.template.templateName}" class="span6 input-tooltip"
                                                ...
                                                <div class="control-group">
														...
														<div class="controls controls-row">
																	<input class="uniform" type="radio" name="template.type" value="1" <s:if test='%{resultMap.template.type==1}'>checked="checked"</s:if>>概览页 
																	<input class="uniform" type="radio" name="template.type" value="2" <s:if test='%{resultMap.template.type==2}'>checked="checked"</s:if>>列表页
																	<input class="uniform" type="radio" name="template.type" value="3" <s:if test='%{resultMap.template.type==3}'>checked="checked"</s:if>>正文页
														</div>
                                                </div>
                                                <div class="control-group" id="keyControl">
                                                    <label for="key" class="control-label">生成文件路径</label>
                                                    <div class="controls">
                                                    	<s:textfield id="key" name="template.path"  value="%{resultMap.template.path}"  class="span6 input-tooltip"
                                                ...
                                                <div class="control-group">
														...
														<div class="controls controls-row">
																	<input class="uniform" type="radio" name="template.open" value="true" <s:if test='%{resultMap.template.open}'>checked="checked"</s:if>>是 
																	<input class="uniform" type="radio" name="template.open" value="false" <s:if test='%{!resultMap.template.open}'>checked="checked"</s:if>>否
														</div>
                                                </div>
                                                <div class="control-group">
														<label class="control-label">是否定时生成</label>
														<div class="controls controls-row">
																	<input class="uniform" type="radio" name="template.timingGenerate" value="true" <s:if test='%{resultMap.template.timingGenerate}'>checked="checked"</s:if>>是 
																	<input class="uniform" type="radio" name="template.timingGenerate" value="false"  <s:if test='%{!resultMap.template.timingGenerate}'>checked="checked"</s:if>>否
														</div>
                                                </div>
                                                <div class="control-group" id="keyControl">
                                                    <label for="key" class="control-label">模板文件名</label>
                                                    <div class="controls">
                                                    	<s:textfield id="templateFileName" name="template.templateFileName" value="%{resultMap.template.templateFileName}"  class="span6 input-tooltip"
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                    	<s:textfield id="memo" name="template.memo" value="%{resultMap.template.memo}"  class="span6 input-tooltip"
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                               <textarea id="templateSource" name="template.templateSource" class="span6" ><s:property value="%{resultMap.template.templateSource}"/></textarea>
                                                    </div>
                                                </div>
												...
												<div class="control-group">
                                            		...
                                            		<div class="controls">
		                                             ...
		                                             <!-- headerValue="无涉及文章栏目" headerKey="%{null}" -->
		                                              <s:select id="articleCat" name="articleCatIds" multiple="true" size="10"   list="articleCatList" listKey="catId" listValue="catNameShow"  value="%{articleCatIds}"></s:select>
		                                              </div>
												</div>
