    ...
    <body>
                                                ...
                                                <ul class="nav">
                                                    ...
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                        	<li><a href="news_input.do">图文消息组合</a></li>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                /*----------- END newsDataTable CODE -------------------------*/
                $('#newsDataTable tbody').on( 'click', 'button.edit', function () {
                    location.href = "news_modify.do?news.id="+$(this).attr("dataid");
                }); 
                $('#newsDataTable tbody').on( 'click', 'button.remove', function () {
                    var idsvalue = $(this).attr("dataid");
        			bootbox.confirm("您确定要删除操作吗?", function(result) {
            			if(result){
                        	$.ajax({
                        		type:'post',
                        		url:'api/news_delete.do',
                        		data:{ids:idsvalue},
                        		dataType:'json',
                        		beforeSend: function(){
                        		},
