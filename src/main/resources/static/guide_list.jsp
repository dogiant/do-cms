    ...
    <body>
                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        <header>
                                            ...
                                            <div class="toolbar">
                                                <ul class="nav">
                                                    <li><a href="guide_input.do">应用指南录入</a></li>
                                                    <li class="dropdown">
                                                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                                            <i class="icon-th-large"></i>
                                                        </a>
                                                        <ul class="dropdown-menu">
                                                        	<li><a href="guide_list.do">应用指南列表</a></li>
                                                        	<li><a href="guide_input.do">应用指南录入</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
	            ...
	            success: function(data) {
	                if(data.success){
	                	...
	                	$.each(data.pagedResult.rs, function(i, obj){      
	                	      ...
	                	      trHtml+="<td>";
	                	      trHtml+="<a href=\"guide_modify.do?id="+obj.id+"\" dataid=\""+obj.id+"\" class=\"btn edit\">编辑</a>";
        ...
        $(function() {
        	...
        	$(document).on("click",".remove",function(){
        		...
        		var obj = $(this);
    			bootbox.confirm("您确定要将此应用指南删除吗?", function(result) {
        			if(result){
                    	$.ajax({
                    		type:'post',
                    		url:'api/guide_delete.do',
                    		data:{"id":idsvalue},
                    		dataType:'json',
                    		beforeSend: function(){
                    		},
