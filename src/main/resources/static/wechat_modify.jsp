                                    ...
                                    <div class="box dark">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <s:form id="weChatForm" namespace="/api" action="wechat_update" method="post" > 
                                                <div class="control-group">
                                                	<s:hidden  id="weChatPK" name="weChat.id" value="%{resultMap.weChat.id}"></s:hidden>
                                                	<s:hidden  id="headImg" name="weChat.headImg" value="%{resultMap.weChat.headImg}"></s:hidden>
                                                    <label for="text1" class="control-label">公众号名称</label>
                                                    <div class="controls with-tooltip">
                                                        <s:textfield id="name" name="weChat.name" class="span6 input-tooltip"
                                                               data-original-title="请输入您的公众号名称" data-placement="bottom" value="%{resultMap.weChat.name}"></s:textfield>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
                                                        <s:textfield id="email" name="weChat.email" class="span6 input-tooltip" 
                                                               data-original-title="请输入您的微信公众号登录邮箱" data-placement="top" value="%{resultMap.weChat.email}"/>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        data-original-title="请输入您的微信公众号原始ID" data-placement="bottom" value="%{resultMap.weChat.originId}"/>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        data-original-title="请输入您的微信号" data-placement="bottom" value="%{resultMap.weChat.weChatId}"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
														...
														<div class="controls controls-row">
                                                        	<input class="uniform" type="radio" name="weChat.type" value="1" <s:if test="%{resultMap.weChat.type==1}"> checked="checked"</s:if>>订阅号
                                                        	<input class="uniform" type="radio" name="weChat.type" value="2" <s:if test="%{resultMap.weChat.type==2}"> checked="checked"</s:if>>服务号
                                               ...
                                               <div class="control-group">
														...
														<div class="controls controls-row">
																	<input class="uniform" type="radio" name="weChat.isCertified" value="false" <s:if test="%{!resultMap.weChat.isCertified}"> checked="checked"</s:if>>未认证
                                                                    <input class="uniform" type="radio" name="weChat.isCertified" value="true" <s:if test="%{resultMap.weChat.isCertified}"> checked="checked"</s:if>>已认证        
													</div>
                                               </div>
                                                <div class="control-group">
			 ...
			 $("#weChatForm").validate({
			        rules: {
			        	"weChat.name":  {
							...
							remote:{
						    	type:"POST",
						    	url:"wechat_checkWeChatNameExist.do", 
						    	data:{
						        	"weChat.name":function(){return $("#name").val();},
									"weChat.id":function(){return $("#weChatPK").val();}
						    	} 
						   	},
						},
						"weChat.email": {
							...
							remote:{
						    	type:"POST",
						    	url:"wechat_checkWeChatEmailExist.do", 
						    	data:{
						        	"weChat.email":function(){return $("#email").val();},
									"weChat.id":function(){return $("#weChatPK").val();}
						    	} 
						   	},
						},
						"weChat.originId": {
							...
							remote:{
						    	type:"POST",
						    	url:"wechat_checkWeChatOriginIdExist.do", 
						    	data:{
						        	"weChat.email":function(){return $("#originId").val();},
									"weChat.id":function(){return $("#weChatPK").val();}
						    	} 
						   	},
						},
						"weChat.weChatId": {
							...
							remote:{
						    	type:"POST",
						    	url:"wechat_checkWeChatIdExist.do", 
						    	data:{
						        	"weChat.email":function(){return $("#weChatId").val();},
									"weChat.id":function(){return $("#weChatPK").val();}
						    	} 
						   	},
						},
			 	...
			 	function showResponse(data)  { 
				 	if(data.success){
							bootbox.alert('您的微信:'+ data.weChat.name+'('+data.weChat.weChatId +')' +'信息已经成功修改接入本系统!'+ '<br/>' +
								'如果涉及到微信号修改，'+'请登录微信公众平台: '+ '<br/>' +
								'<a href=https://mp.weixin.qq.com/ target=_blank>https://mp.weixin.qq.com/</a>  开发者中心'+ '<br/>' 
							...
							var  wechat_list = function(){
								location.href="wechat_list.do";
							}
							window.setTimeout(wechat_list, 3000); 
				 		});
					}else{
