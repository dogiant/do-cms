                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        <header>
                                            ...
                                            <div class="toolbar">
                                                <ul class="nav">
                                                    <li><a href="keyword_reply_list.do">当前关键词回复</a></li>
                                                    <li class="dropdown">
            ...
            $(function() {
            	...
            	$('#textDataTable').dataTable({
                    ...
                    "columnDefs": [  
                        ...
                        { "targets": [4],
                        "data": "id" ,
                        "render": function(data, type, full) { return "<input type=\"text\" name=\"keyword\" placeholder=\"请输入关键词\"/><button class='btn set'  dataid='"+data+"'><i class='icon-check' title='设定为关键词回复'></i></button>"; } 
                        } 
                    ],
                ...
                $('#textDataTable tbody').on( 'click', 'button.set', function () {
        			...
        			bootbox.confirm("您确定要设定此条消息为关键词回复吗?", function(result) {
            			if(result){
                        	$.ajax({
                        		type:'post',
                        		url:'api/keyword_reply_set.do',
                        		data:{msgType:"text","id":messageId,"keyword":keyword},
                        		dataType:'json',
                        		beforeSend: function(){
                        		},
                        		success:function(data){
        			...
        			bootbox.confirm("您确定要设定此条消息为关键词回复吗?", function(result) {
            			if(result){
                        	$.ajax({
                        		type:'post',
                        		url:'api/keyword_reply_set.do',
                        		data:{msgType:"news","id":messageId,"keyword":keyword},
                        		dataType:'json',
                        		beforeSend: function(){
                        		},
                        		success:function(data){
