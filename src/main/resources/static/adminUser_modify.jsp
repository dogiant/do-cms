                                    ...
                                    <div class="box dark">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	...
                                        	<div class="form-horizontal">
                                                <s:form id="adminUserForm" namespace="/api" action="adminUser_update" method="post" > 
                                                <div class="control-group">
                                                	<s:hidden id="userId" name="adminUser.userId" value="%{resultMap.adminUser.userId}"></s:hidden>
                                                    <label for="text1" class="control-label">用户名</label>
                                                    <div class="controls with-tooltip">
                                                        <s:textfield id="userName" name="adminUser.userName" value="%{resultMap.adminUser.userName}" class="span6 input-tooltip"
                                                               data-original-title="请输入管理员用户名" data-placement="bottom" disabled="true"></s:textfield>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label for="pass1" class="control-label">昵称</label>
                                                    <div class="controls with-tooltip">
                                                        <s:textfield id="nickname" name="adminUser.nickname" value="%{resultMap.adminUser.nickname}" class="span6 input-tooltip" 
                                                               data-original-title="请输入管理员昵称" data-placement="top" disabled="true"/>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <s:textfield type="text"  id="email"  name="adminUser.email" value="%{resultMap.adminUser.email}" class="span6 input-tooltip"  
                                                ...
                                                <div class="control-group">
													...
													<div class="controls">
                                                        <s:textfield type="text"  id="phone"  name="adminUser.phone" value="%{resultMap.adminUser.phone}" class="span6 input-tooltip"  
                                                        data-original-title="请输入管理员电子邮箱" data-placement="bottom" />
                                                    </div>
                                               </div>
                                               ...
                                               <div class="control-group">
                                                    ...
                                                    <s:iterator value="#roleList" id="role" status="st">
                                                        <label>
                                                            <input class="uniform" type="checkbox" name="roleIds" value="<s:property value="#role.roleId"/>"  <s:if test="%{resultMap.adminUser!=null && resultMap.adminUser.hasRole(#role.roleId)}">checked="checked"</s:if> > <s:property value="#role.roleName" />
                                                        </label>
                                                    </s:iterator>
                                                    </div>
                                                </div>
