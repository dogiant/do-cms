                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        <header>
                                            ...
                                            <div class="toolbar">
                                                <ul class="nav">
                                                    <li><a href="systemModel_list.do">系统模块管理</a></li>
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a href="systemModel_list.do">系统模块管理</a></li>
                                                            <li><a href="systemModel_input.do">系统模块录入</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	...
                                        	<div class="form-horizontal">
                                               	<s:form id="systemModelForm" namespace="/api" action="systemModel_update" method="post" > 
                                               	<div class="control-group">
                                               		<s:hidden id="model" name="systemModel.model" value="%{resultMap.systemModel.model}"></s:hidden>
                                                    <label for="text1" class="control-label">模块标识</label>
                                                    <div class="controls with-tooltip">
                                                        <s:textfield id="model" name="systemModel.model" value="%{resultMap.systemModel.model}" class="span6 input-tooltip"
                                                               data-original-title="请输入模块标识" disabled="true" data-placement="bottom" ></s:textfield>
                                                    </div>
                                               	</div>
                                               	<div class="control-group">
                                                    <label for="text1" class="control-label">模块名称</label>
                                                    <div class="controls with-tooltip">
                                                        <s:textfield id="name" name="systemModel.name" value="%{resultMap.systemModel.name}" class="span6 input-tooltip"
                                                               data-original-title="请输入模块名称" data-placement="bottom" ></s:textfield>
                                                    </div>
                                               	</div>
		...
		$().ready(function() {
			 $("#systemModelForm").validate({
					...
					messages: {
						"systemModel.model":{
							required: "请输入模块标识",
	    					minlength: "模块标识至少3位字符",
	    					maxlength: "模块标识不能超过20字符"
						},
						"systemModel.name":  {
							required: "请输入模块名称",
	    					minlength: "模块名称至少3位字符",
	    					maxlength: "模块名称不能超过20字符"
						}
					},
			 	...
			 	function showResponse(data) { 
				 	if(data.success){
						bootbox.alert('系统模块录入成功!' ,function(){
							message_box.show('将跳转到系统模块管理列表页!','success');
							var  page_list = function(){
								location.href="systemModel_list.do";
							}
