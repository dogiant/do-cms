                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	<div class="span12">
  												...
  												<div class="span7">
	                                                ...
	                                                <s:form id="newsForm" namespace="/api" action="document_add" method="post" > 
	                                                <div class="control-group">
	                                                    <label for="newsTitle" class="control-label">应用文档标题</label>
	                                                    <div class="controls with-tooltip">
	                                                        <s:textfield id="newsTitle" name="document.name" class="span6 input-tooltip"   data-placement="top" />
	                                                    </div>
	                                                </div>
	                                                ...
	                                                <div class="control-group">
	                                                    ...
	                                                    <div class="controls with-tooltip">
	                                                    	<span class="btn btn-file">
                                                                 ...
                                                                 <input id="fileUrl" type="hidden" name="document.fileUrl" />
                                                            </span>
