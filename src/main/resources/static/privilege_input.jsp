                                    ...
                                    <div class="box dark">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	...
                                        	<div class="form-horizontal">
                                               	<s:form id="privilegeForm" namespace="/api" action="privilege_add" method="post" > 
                                               	<div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
                                                        <s:select name="privilege.id.model" headerValue="选择模块"
															...
															emptyOption="false" value="%{resultMap.privilege.id.model}" ></s:select>
                                                    </div>
                                               	</div>
                                               	<div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
                                                    	<s:textfield id="name" name="privilege.id.privilegeValue" value="%{resultMap.privilege.id.privilegeValue}"class="span6 input-tooltip"
                                                               data-original-title="请输入权限值" data-placement="bottom" ></s:textfield>
                                                    </div>
                                               	</div>
                                               	<div class="control-group">
