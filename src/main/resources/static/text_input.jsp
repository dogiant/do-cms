                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        <header>
                                            ...
                                            <div class="toolbar">
                                                <ul class="nav">
                                                    <li><a href="text_list.do">文本消息列表</a></li>
                                                    <li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	...
                                        	<div class="form-horizontal">
                                                <s:form id="textForm" namespace="/api" action="text_add" method="post" > 
                                                <div class="control-group">
                                                    <label for="autosize" class="control-label">文本消息</label>
                                                    <div class="controls">
                                                    	<textarea id="autosize" name="text.content" class="span6" ></textarea>
                                                    </div>
                                                </div>
                                                <div class="control-group">
														<label class="control-label">是否共享</label>
														<div class="controls controls-row">
																	<input class="uniform" type="radio" name="text.share" value="false" checked="checked">不共享
                                                                    <input class="uniform" type="radio" name="text.share" value="true" >共享        
													</div>
                                               </div>
		...
		$().ready(function() {
			 ...
			 $("#textForm").validate({
			 	...
			 	function showResponse(data)  { 
				 	if(data.success){
						bootbox.alert('您的文本消息已成功录入' ,function(){
							message_box.show('将跳转到您的文本消息列表管理界面!','success');
							var  page_list = function(){
								location.href="text_list.do";
							}
