                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        <header>
                                            ...
                                            <div class="toolbar">
                                                <ul class="nav">
                                                    <li><a href="diode_list.do">二极管产品列表</a></li>
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a href="diode_input.do">稳压二极管</a></li>
                                                            <li><a href="diode_input.do">突波吸收器</a></li>
                                                            <li><a href="diode_input.do">静电保护二极管</a></li>
                                                            <li><a href="diode_input.do">标准整流管</a></li>
                                                            <li><a href="diode_input.do">肖特基整流管</a></li>
                                                            <li><a href="diode_input.do">桥式整流管</a></li>
                                                            <li><a href="diode_input.do">快速整流管</a></li>
                                                            <li><a href="diode_input.do">高效整流管</a></li>
                                                            <li><a href="diode_input.do">开关二极管</a></li>
                                                            <li><a href="diode_input.do">肖特基二极管</a></li>
                                                            <li><a href="diode_input.do">触发二极管</a></li>
                                                            <li><a href="diode_input.do">高频二极管</a></li>
                                                            <li><a href="diode_input.do">高压开关二极管</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	<div class="span12">
  												...
  												<div class="span7">
	                                                ...
	                                                <s:form id="newsForm" namespace="/api" action="article_add" method="post" > 
	                                                <s:if test="%{articleCatList!=null && articleCatList.size()>0}">
		                                                <div class="control-group">
		                                                    <label for="name" class="control-label">文章栏目</label>
		                                                    <div class="controls">
		                                                    	<s:select name="articleItem.articleCat.catId" headerValue="请选择文章栏目" headerKey="%{null}" list="articleCatList" listKey="catId" listValue="catNameShow" emptyOption="false" ></s:select>
		                                                    </div>
	                                                	</div>
                                                	</s:if>
	                                                <div class="control-group">
	                                                    ...
	                                                    <div class="controls with-tooltip">
	                                                        <s:textfield id="newsSubtitle" name="articleItem.subtitle" class="span6 input-tooltip"   data-placement="top" />
	                                                    </div>
	                                                </div>
	                                                <div class="control-group">
	                                                    <label for="newsAuthor" class="control-label">作者</label>
	                                                    <div class="controls with-tooltip">
	                                                        <s:textfield id="newsAuthor" name="articleItem.author" class="span6 input-tooltip"   data-placement="top" />（选填）
	                                                    </div>
	                                                </div>
	                                                <div class="control-group">
	                                                    ...
	                                                    <div class="controls with-tooltip">
	                                                            <div id="uploadTips">
	                                                             ...
	                                                             <span class="btn btn-file">
                                                                    ...
                                                                    <input id="picUrl" type="hidden" name="articleItem.picUrl" />
                                                                </span>
		                                                         ...
		                                                         <p class="js_cover upload_preview" style="display: none;"><img id="cover_preview"  src="">
													                ...
													                <label for="" class="frm_checkbox_label js_show_cover_pic selected">
													                    ...
													                    <input type="checkbox" class="frm_checkbox" name="articleItem.coverIntoContent" value="true">
													                   封面图片显示在正文中 
													                </label>
													            </p>
													            -->
	                                                ...
	                                                <div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                    	<textarea id="newsDigest" name="articleItem.digest" class="span6" ></textarea>
	                                                    </div>
	                                                </div>
	                                                <div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                    	...
	                                                    	<input type="hidden"  id="articleItemContent" name="articleItem.content"></input>
	                                                    </div>
	                                                </div>
	                                                <div class="control-group">
	                                                    <label for="newsSourceUrl" class="control-label">原文引用链接</label>
	                                                    <div class="controls with-tooltip">
	                                                        <s:textfield id="newsSourceUrl" name="articleItem.sourceUrl" class="span6 input-tooltip" data-placement="top" />
	                                                    </div>
	                                                </div>
	                                                <div class="control-group">
	                                                    <label for="linkUrl" class="control-label">跳转链接</label>
	                                                    <div class="controls with-tooltip">
	                                                        <s:textfield id="url" name="articleItem.linkUrl" class="span6 input-tooltip" data-placement="top"  />
	                                                    </div>
	                                                </div>
	                                                <div class="control-group">
	                                                    ...
	                                                    <div class="controls with-tooltip">
	                                                    	<span class="btn btn-file">
                                                                 ...
                                                                 <input id="fileUrl" type="hidden" name="articleItem.fileUrl" />
                                                            </span>
	                                                ...
	                                                <div class="control-group">
															...
															<div class="controls controls-row">
																		<input class="uniform" type="radio" name="articleItem.recommend" value="true" checked="checked">推荐
	                                                                    <input class="uniform" type="radio" name="articleItem.recommend" value="false" >不推荐       
														</div>
	                                               </div>
