                                    ...
                                    <div class="box dark">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	...
                                        	<div class="form-horizontal">
                                                <s:form id="menuForm" namespace="/api" action="menu_add" method="post" > 
                                                <div class="control-group">
                                                    <label for="name" class="control-label">上级菜单</label>
                                                    <div class="controls">
                                                    	<s:select name="customMenu.parent.id" headerValue="顶级菜单" headerKey="%{null}" list="customMenuList" listKey="id" listValue="name" emptyOption="false" value="%{#request.customMenu.parent.id}" ></s:select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                    	<s:textfield id="name" name="customMenu.name" class="span6 input-tooltip"
                                                               data-original-title="请输入菜单名称" data-placement="bottom" ></s:textfield>
                                                    </div>
                                                </div>
                                                <div class="control-group">
														<label class="control-label">菜单类型</label>
														<div class="controls controls-row">
																	<input class="uniform" type="radio" name="customMenu.type" value="click" checked="checked">关键词
                                                                    <input class="uniform" type="radio" name="customMenu.type" value="view" >网页链接        
													</div>
                                               </div>
                                                ...
                                                <div class="control-group" id="urlControl" style="display: none;">
                                                    ...
                                                    <div class="controls">
                                                    	<s:textfield id="url" name="customMenu.url" class="span6 input-tooltip"
                                                               data-original-title="请输入网页链接" data-placement="bottom" ></s:textfield>
                                                    </div>
                                                </div>
                                                <div class="control-group">
		...
		$().ready(function() {
			 $("#menuForm").validate({
			 	...
			 	function showResponse(data)  { 
				 	if(data.success){
						bootbox.alert('自定义菜单已成功录入' ,function(){
