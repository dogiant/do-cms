...
<!--[if gt IE 8]><!-->  <html class="no-js">                        <!--<![endif]-->
    ...
    <body>
                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        <header>
                                            ...
                                            <div class="toolbar">
                                                <ul class="nav">
                                                    <li><a href="guide_input.do">应用文档录入</a></li>
                                                    <li class="dropdown">
                                                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                                            <i class="icon-th-large"></i>
                                                        </a>
                                                        <ul class="dropdown-menu">
                                                        	<li><a href="guide_list.do">应用文档列表</a></li>
                                                        	<li><a href="guide_input.do">应用文档录入</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	<div class="span12">
  												...
  												<div class="span7">
	                                                ...
	                                                <s:form id="newsForm" namespace="/api" action="guide_update" method="post" > 
	                                                <s:hidden  id="articleId" name="guide.id" value="%{resultMap.guide.id}"></s:hidden>
	                                                <div class="control-group">
	                                                    <label for="newsTitle" class="control-label">标题</label>
	                                                    <div class="controls with-tooltip">
	                                                        <s:textfield id="newsTitle" name="guide.name" value="%{resultMap.guide.name}"  class="span6 input-tooltip"   data-placement="top" />
	                                                    </div>
	                                                </div>
	                                                ...
	                                                <div class="control-group">
	                                                    ...
	                                                    <div class="controls with-tooltip">
	                                                    	<span class="btn btn-file">
                                                                 ...
                                                                 <s:hidden id="fileUrl" type="hidden" name="guide.fileUrl"  value="%{resultMap.guide.fileUrl}"  />
                                                            </span>
	                                                        <s:if test="%{resultMap.guide.fileUrl!=null}">
	                                                    	<span><a href="http://file.agertech.com.cn<s:property value="%{resultMap.guide.fileUrl}"/>" id="fileUrlShow">点击下载查看已上传文件</a></span>
	                                                        </s:if>
	                                                        <s:else>
        ...
        <script>window.jQuery || guide.write('<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"><\/script>')</script>
        ...
        <script>window.jQuery.ui || guide.write('<script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.0/jquery-ui.min.js"><\/script>')</script>
		...
		function uploadFileAjaxSubmit(o) {
			...
			var options = {
				dataType : "json",
				data : {returnType:"json","channel":"guide","isPic":false,upload:$file.val()},
