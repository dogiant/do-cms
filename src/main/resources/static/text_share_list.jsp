...
<!--[if gt IE 8]><!-->  <html class="no-js">                        <!--<![endif]-->
    ...
    <body>
                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        ...
                                        <div  id="div-1"  class="accordion-body collapse in body">
                                            <table id="shareTextDataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                <thead>
                                                    <tr>
                                                    	<th>序号</th>
                                                        <th>消息内容</th>
        ...
        <script type="text/javascript">
            $(function() {
                /*----------- BEGIN shareTextDataTable CODE -------------------------*/
            	$('#shareTextDataTable').dataTable({
                	"processing": true,
                    "serverSide": true,
                    "ajax": "api/text_share_list.do",
                    "columns": [
                        { "data": "id" },
                        { "data": "messageShow"},
                        { "data": "ctime" },
                    ...
                    "columnDefs": [  
                       { "bSortable": false, 
                        ...
                        { "targets": [5],
                        "data": "id" ,
                        "render": function(data, type, full) { return "<button class='btn view'  dataid='"+data+"'><i class='icon-search' ></i></button> "; } 
                        } 
                    ],
                	"aaSorting": [[ 2, "desc" ]] ,
                ...
                /*----------- END shareTextDataTable CODE -------------------------*/
                $('#shareTextDataTable tbody').on( 'click', 'button.view', function () {
                	$.ajax({
                		type:'post',
                		url:'api/text_get.do',
