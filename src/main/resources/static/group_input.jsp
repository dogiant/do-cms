                                    ...
                                    <div class="box dark">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                        	...
                                        	<div class="form-horizontal">
                                                <s:form id="groupForm" namespace="/api" action="group_add" method="post" > 
                                                
                                                <div class="control-group">
                                                    <label for="name" class="control-label">分组名称</label>
                                                    <div class="controls">
                                                    	<s:textfield id="name" name="group.name" class="span6 input-tooltip"
		...
		$().ready(function() {
			 $("#groupForm").validate({
			 	...
			 	function showResponse(data)  { 
				 	if(data.success){
						bootbox.alert('用户分组已成功录入' ,function(){
