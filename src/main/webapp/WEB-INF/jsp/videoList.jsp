                                ...
                                <div class="span12">
                                    <div class="box dark">
                                        <header>
                                            ...
                                            <div class="toolbar">
                                                <ul class="nav">
                                                    <li><a href="uploadVedio.do">视频上传</a></li>
                                                    <li class="dropdown">
                                                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                                            <i class="icon-th-large"></i>
                                                        </a>
                                                        <ul class="dropdown-menu">
                                                        	<li><a href="article_cat_input.do">视频上传</a></li>
                                                            <li><a href="article_cat_list.do">视频列表</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                        ...
                                        <div  id="div-1"  class="accordion-body collapse in body">
                                            <table id="articleCatDataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                ...
                                                <tbody>
                                                <c:forEach items="${videoList}" var="obj" varStatus="status">
                                                        <tr>
                                                        <td><font color="#FF0000">${obj.fileId}</font></td>
                                                    	<td>${obj.videoName}</td>
                                                    	<td>${obj.keywords}</td>
                                                    	<td>${obj.videoDesc}</td>
                                                        <td width="200"><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${obj.ctime}" /></td>
                                                        <td>${obj.url}</td>
                                                        </tr>
                                                </c:forEach>
                                                </tbody>
